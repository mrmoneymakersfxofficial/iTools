...
export function RedMarqueeBar() {
  ...
  return (
    <div className="w-full bg-[#E60000] text-white overflow-hidden py-2 select-none shadow-sm" id="envios-peru" data-section="Envíos a Todo el Perú" data-sanity-doc="uiConfig">
